...
namespace FileMaker.Models.Utilities
{
    ...
    public class HTTP
    {
        ...
        public async static Task<string> AcquireAccessToken(string url, object credentials)
        {
            ...
            string authResult = await HTTP.Post(url, "", credentials);
